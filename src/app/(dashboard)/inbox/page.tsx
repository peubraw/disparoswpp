      ...
      <div className="flex flex-1 gap-6 overflow-hidden">
        <aside className="w-64 shrink-0 flex-col gap-2 hidden md:flex">
          ...
          <div className="flex-1 overflow-y-auto pr-4">
            <div className="flex flex-col gap-1">
              <Link
                href="/inbox"
                className="px-3 py-2 rounded-md bg-secondary text-secondary-foreground font-medium text-sm transition-colors"
              >
                Todas as mensagens
              </Link>
        ...
        <main className="flex-1 flex flex-col border rounded-lg bg-card overflow-hidden">
          <div className="flex items-center justify-between p-4 border-b">
            <h1 className="font-semibold text-lg">Todas as mensagens</h1>
            <form action={async () => { "use server"; await markAllAsRead(undefined); }}>
